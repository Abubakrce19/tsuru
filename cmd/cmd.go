...
// Deprecated: use NewManagerPanicExiter instead. Handle panic(*PanicExitError) accordingly
...
// Deprecated: use BuildBaseManagerPanicExiter instead. Handle panic(*PanicExitError) accordingly
